...
class PurchaseReport6 extends React.Component {
  constructor(props) {
      super(props);
...
//                "Authorization": `token ${token}`
        ...
        fetch("/api/v1/report_6/"+`${this.props.company_id}`, lookups)
        .then(res => {
            if(res.status > 400){
  ...
  {console.log({data})}
    ...
    return (
       <div className="">
         ...
         <Card>
            <CardBody>
            <CardTitle> Report 6 </CardTitle>
            <br/>
                        <h3>GST Number is blank</h3>
...
export default PurchaseReport6;