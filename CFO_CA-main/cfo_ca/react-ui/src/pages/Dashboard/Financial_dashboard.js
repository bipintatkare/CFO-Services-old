...
//        fetch(process.env.REACT_APP_BASEURL_BACKEND+"/api/v1/mis_dar/"+`${this.props.company_id}`, lookups)
...
//                "Authorization": `token ${token}`
        ...
        fetch(process.env.REACT_APP_BASEURL_BACKEND+"/api/v1/mis_dar/"+`${this.props.company_id}`, lookups)
//        fetch("/api/v1/mis_fdbo/"+`${this.state.company_id}`, lookups)
        .then(res => {
            if(res.status > 400){
                return console.log("Something went wrong")
            }
        ...
        return (
           ...
           <Row>
                 ...
                 <Col md="6" md="6" xs="6" sm="6" className="text-right">
                                     ...
                                     {data_received!=null && data_received.length > 0?
                  ...
                  <Col md="12">
                        ...
                        <table className="table table table-bordered">
                         ...
                         <tr>
                            ...
                            <td style={{border: "1px solid black"}}></td>
                            <td style={{border: "1px solid black"}}><center>{obj.month_closing}</center></td>
                  ...
                  <Col style={{marginTop:"2%",marginBottom:"10%"}} xl="12" md="12">
                        ...
                        <table className="table table table-bordered">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td style={{border: "1px solid black"}} scope="row"><center>Outstanding</center></td>
                                  <td style={{border: "1px solid black"}} scope="row"><center>1558979788.00</center></td>

                                </tr>
                                <tr>
                                  <td style={{border: "1px solid black"}} scope="row"><center>Number Of Days</center></td>
                                  <td style={{border: "1px solid black"}} scope="row"><center></center></td>
                                </tr>
...
<div style={{display: "none"}}>
  {data_received!=null && data_received.length > 0? data_received.map((Item,index)=>{
                             ...
                             <tr>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td style={{border: "1px solid black"}} scope="row" colspan="2"><center></center></td>
                         ...
                         <tr>
                            ...
                            <td style={{border: "1px solid black"}} colspan="2"></td>
                            <td style={{border: "1px solid black"}} colspan="1"><center>0.0</center></td>
                            <td style={{border: "1px solid black"}} colspan="2"><center></center></td>
                          </tr>
                         <tr>
