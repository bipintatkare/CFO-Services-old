...
class PurchaseReport2 extends React.Component {
  constructor(props) {
      super(props);
...
//                "Authorization": `token ${token}`
        ...
        fetch("/api/v1/report_purchase2/"+`${this.props.company_id}`, lookups)
        .then(res => {
            if(res.status > 400){
    ...
    return (
       <div className="">
         ...
         <Card>
            ...
            <br/>
            <h3>Matching Fields : </h3><p>GST No,Invoice No., Taxable Amount</p>
            <h3>Non Matching Fields : </h3><p>Invoice Date</p>
            {/*<br/>
