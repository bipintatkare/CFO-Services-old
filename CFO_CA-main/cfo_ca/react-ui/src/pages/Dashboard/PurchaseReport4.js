...
class PurchaseReport4 extends React.Component {
  constructor(props) {
      super(props);
...
//                "Authorization": `token ${token}`
        ...
        fetch("/api/v1/report_purchase4/"+`${this.props.company_id}`, lookups)
        .then(res => {
            if(res.status > 400){
  ...
  {console.log({data})}
    ...
    return (
       <div className="">
         ...
         <Card>
            <CardBody>
            <CardTitle> Report 4 </CardTitle>
            <br/>
            <h3>Entries Present in Uploaded File But Are Absent In Tally</h3>
            {/*<br/>
...
export default PurchaseReport4;