...
class PurchaseReport5 extends React.Component {
  constructor(props) {
      super(props);
  ...
  this.state = {
    ...
    datamain: [
      ...
      { id:"3",
        dataField: "customer_billing_name",
        text: "Billing Name",
      },
      { id:"4",
        dataField: "inv_no",
...
//                "Authorization": `token ${token}`
        ...
        fetch("/api/v1/report_purchase5/"+`${this.props.company_id}`, lookups)
        .then(res => {
            if(res.status > 400){
  ...
  {console.log({data})}
    ...
    return (
       <div className="">
         ...
         <Card>
            <CardBody>
            <CardTitle> Report 5 </CardTitle>
            <br/>
                        <h3>Entries Present in Tally But Are Absent In Uploaded File</h3>
...
export default PurchaseReport5;